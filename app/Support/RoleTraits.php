...
final class RoleTraits
{
    ...
    public static function seesMoney(?User $user): bool
    {
        ...
        // Ни одной роли — не видит. Роли удаляет владелец, и человек остаётся
        // без роли на законных основаниях; «нет запрещающей роли» тогда
        // означало бы «можно всё», то есть деньги открывались бы сами собой.
        // Запрет по умолчанию: доступ дают, а не забывают отнять.
