    ...
    theme: {
        extend: {
            ...
            colors: {
                ...
                /*
                 * Палитра администрирования (Права доступа, Структура компании).
                 * Эти две страницы сделаны по образцу Битрикса и живут на его
                 * цвете; остальной ERP остаётся на индиго (§9.3). Держим их
                 * отдельным семейством, а не подменяем primary: подмена увела
                 * бы за собой всё приложение разом.
                 */
                bx: {
                    50: '#EFF9FE',
                    100: '#D9F1FC',
                    200: '#AEE4F9',
                    400: '#2FC6F6',   // Bitrix Cyan — акцент
                    500: '#2684FC',   // Soft Blue — действие
                    600: '#1E6FDA',
                    canvas: '#F5F7FA',
                },
