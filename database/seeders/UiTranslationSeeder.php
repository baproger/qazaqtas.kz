...
class UiTranslationSeeder extends Seeder
{
    public function run(): void
    {
        $rows = [
            ...
            ['nav.siteProjects', 'nav', 'Объекты сайта', 'Сайт нысандары'],
            ...
            // Разделы меню — их владелец тоже переименовывает через «Переводы».
            ['nav.sales', 'nav', 'Продажи', 'Сатылымдар'],
            ['nav.factory', 'nav', 'Производство', 'Өндіріс'],
            ['nav.production', 'nav', 'Наряды бригад', 'Бригада нарядтары'],
            ['nav.site', 'nav', 'Сайт', 'Сайт'],
            ['nav.admin', 'nav', 'Управление', 'Басқару'],
