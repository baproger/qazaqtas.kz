...
return new class extends Migration
{
    private const CATEGORIES = [
        'Аренда', 'Комуслуги', 'Электроэнергия', 'Интернет', 'Бензин / ГСМ',
        'Сырьё и материалы', 'Формы и оснастка', 'Ремонт и обслуживание оборудования',
        'Доставка и логистика', 'Реклама и маркетинг',
        'Канцтовары', 'Хозтовары', 'Продукты питания', 'Офисные расходы',
        'Налоги', 'Кредит', 'Прочее',
    ];
