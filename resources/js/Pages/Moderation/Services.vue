...
const tr = useE();
const props = defineProps({ services: Object, counts: Object, filters: Object, statuses: Object });
...
<template>
    ...
    <AppLayout>
        ...
        <div class="mb-4 flex rounded-2xl bg-white/70 p-1 text-sm shadow-soft backdrop-blur w-fit">
