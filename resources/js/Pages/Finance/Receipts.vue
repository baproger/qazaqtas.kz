        ...
        <div class="mt-6 rounded-2xl border border-slate-100 bg-white shadow-sm">
            <div class="flex flex-wrap items-center justify-between gap-3 border-b px-6 py-4">
                <div class="flex items-center gap-3">
                    ...
                    <span class="hidden rounded-full bg-slate-100 px-2.5 py-1 text-xs font-medium text-slate-500 sm:inline-flex">{{ $e('всего') }} <b class="ml-1 tabular-nums">{{ money(allTime) }}</b></span>
                </div>
